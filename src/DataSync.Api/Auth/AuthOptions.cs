...
/// <summary>
/// How this deployment decides who may use it, read from the <c>DataSync:Auth</c> configuration
/// section.
/// </summary>
public sealed class AuthOptions
{
    public const string SessionCookie = "datasync.session";
    ...
    /// manages membership in a directory and asking them to manage DataSync's roles inside DataSync
    ...
    {
        var section = configuration.GetSection("DataSync:Auth");
