...
/// <c>CR_DISP_UNDER_SUBMISSION</c> with a request id; that id is what <c>datasync cert retrieve</c>
...
public static class AdcsEnrollment
{
    ...
    /// <c>CASERVER\CA Name</c> shape <c>DataSync:Certificates:CaConfig</c> holds).</summary>
    ...
    /// <c>datasync cert retrieve --request-id</c>.</summary>
        ...
        switch (disposition)
        {
            ...
            case CrDispUnderSubmission:
                ...
                return new EnrollmentResult(
                    ...
                    $"'datasync cert retrieve --request-id {pendingRequestId}'.");
