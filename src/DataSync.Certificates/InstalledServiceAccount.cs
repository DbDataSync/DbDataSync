...
/// <summary>
/// Reads back which account the installed DataSync Windows service runs as — the second rung of the
...
/// <para>
/// **The doc's own text says this reads the account "the same way <c>datasync service status</c>
...
/// in <c>src/DataSync.Cli/ServiceCommand.cs</c>) — it never parses anything. There was no existing
