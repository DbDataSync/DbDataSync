...
/// which <c>datasync cert retrieve</c> cannot work at all without.
/// <para>
...
{
    private const string KeyNamePrefix = "DataSync-PendingEnrollment-";
    ...
    /// needs an elevated prompt the same way <c>datasync service install</c> does, so a machine-wide key
