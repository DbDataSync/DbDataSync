...
public sealed class SegmentingStrategyConfig
{
    ...
    /// acceptable is the operator's judgement about their own tables, not DataSync's to make for them.
    /// What DataSync owes is that the consequence is visible before they choose it, which is the same
