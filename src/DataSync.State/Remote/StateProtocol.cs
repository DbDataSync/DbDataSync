...
public static class StateProtocol
{
    ...
    public const string TokenHeader = "X-DataSync-Runner-Token";
    ...
    public const string TokenEnvironmentVariable = "DATASYNC_RUNNER_TOKEN";

    /// <summary>The environment variable carrying the loopback base address of the state endpoint.</summary>
    public const string EndpointEnvironmentVariable = "DATASYNC_STATE_ENDPOINT";
}
