...
public sealed class AdminCertificateController(AdminCertificateService service, CurrentUser currentUser) : ControllerBase
{
    ...
    /// <summary>Does not take effect until the DbDataSync service restarts — <see cref="AdminCertificateService.Bind"/>
...
/// <param name="CaConfig">Overrides <c>DbDataSync:Certificates:CaConfig</c> for this one enrollment when
