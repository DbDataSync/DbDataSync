...
/// Engine-neutral, the same shape <see cref="BulkLoadRequest"/> already establishes for segments; no
...
{
    /// <summary>Same contract as <see cref="BulkLoadRequest.Segments"/>: at least one, an <c>Auto</c>
