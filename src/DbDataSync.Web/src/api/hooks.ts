...
/** Writes one key into dbdatasync.config.yaml — a direct edit of a file-sourced row, or "adopt" of one
 ...
 * above because it never touches dbdatasync.config.yaml and the page never sees what it sets. */
