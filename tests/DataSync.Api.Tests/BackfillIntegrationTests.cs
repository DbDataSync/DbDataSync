...
/// DataSync.TaskRunner worker, and a real SQL Server — proving the properties the whole per-mapping
...
public sealed class BackfillIntegrationTests : IClassFixture<TestApiFactory>, IAsyncLifetime
{
    ...
    private readonly string _databaseName = $"DataSyncBackfillTest_{Guid.NewGuid():N}";
    ...
    public async Task InitializeAsync()
    {
        ...
        SetSecretEnvVar(_connectionName, "DataSync_Test_Pw1");
