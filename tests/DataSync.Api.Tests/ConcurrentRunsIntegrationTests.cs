...
/// data (architecture/implementation/phase-7-e2e-validation.md): triggers several *independent*
...
public sealed class ConcurrentRunsIntegrationTests : IClassFixture<TestApiFactory>, IAsyncLifetime
{
    ...
    private readonly string _databaseName = $"DataSyncConcurrencyTest_{Guid.NewGuid():N}";
