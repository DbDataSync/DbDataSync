...
public sealed class CrossInstanceEndToEndTests : IClassFixture<TestApiFactory>, IAsyncLifetime
{
    ...
    private static string TargetServerConnectionString =>
        Environment.GetEnvironmentVariable("DATASYNC_TEST_MSSQL_TARGET_SERVER")
        ?? "Data Source=localhost,14331;User ID=sa;Password=DataSync_Test_Pw1;TrustServerCertificate=True";

    private readonly TestApiFactory _factory;
    private readonly HttpClient _client;
    private readonly string _databaseName = $"DataSyncE2E_{Guid.NewGuid():N}";
