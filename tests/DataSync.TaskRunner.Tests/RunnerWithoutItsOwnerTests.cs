...
{
    private readonly string _repoRoot = Directory.CreateTempSubdirectory("datasync-runner-exit-").FullName;
    ...
    private static string TaskRunnerDllPath
    {
        get
        {
            ...
            return Path.Combine(
                repoRoot!.FullName, "src", "DataSync.TaskRunner", "bin", configuration, tfm, "DataSync.TaskRunner.dll");
        }
    }
}
