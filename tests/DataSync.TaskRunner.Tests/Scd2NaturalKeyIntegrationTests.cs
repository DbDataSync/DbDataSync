...
public sealed class Scd2NaturalKeyIntegrationTests : IAsyncLifetime
{
    ...
    private readonly string _databaseName = $"DataSyncScd2Test_{Guid.NewGuid():N}";
    private readonly string _repoRoot = Directory.CreateTempSubdirectory("datasync-scd2-e2e-").FullName;
