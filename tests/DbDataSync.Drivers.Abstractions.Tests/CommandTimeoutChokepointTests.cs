...
public sealed class CommandTimeoutChokepointTests
{
    ...
    /// configured timeout.
    /// <para>
    /// <c>DbDataSync.State</c> is deliberately absent — an internal, single-writer store this process
    ...
    [
        "DbDataSync.Core/Sql",
        "DbDataSync.Drivers.Generic",
        "DbDataSync.Drivers.MsSql",
        "DbDataSync.Drivers.Postgres",
        "DbDataSync.Scripting",
        "DbDataSync.Api",
        "DbDataSync.TaskRunner",
        "DbDataSync.Verification",
    ];
