...
{
    private readonly string _tempDir = Directory.CreateTempSubdirectory("dbdatasync-notify-tests-").FullName;
    ...
    public void AFailedRun_ProducesOneNotification_NamingTheReplicationAndTheRun()
    {
        ...
        _runs.CompleteRun(runId, RunStatus.Failed, 0, 0, "Login failed for user 'svc_dbdatasync'.");
